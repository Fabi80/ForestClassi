...
class data_prepro():
    ...
    def scale_features(cls,features):
        ...
        print(features2.describe())
     #   st = StandardScaler()
     #   scaled_features = st.fit_transform(X=features)
    ...
    def split_train_validation(cls,features,labels):
        features_train,features_test,labels_train,labels_test = train_test_split(features,labels,train_size=0.8)
